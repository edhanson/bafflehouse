...
def rewrite_movement_idioms(text: str) -> str:
    ...
    rewrites = [
        ...
        (r"^climb\s+down$",                          r"go down"),
        (r"^climb\s+(?:the\s+)?stairs?$",            r"go up"),
        (r"^go\s+up\s+(?:the\s+)?stairs?$",          r"go up"),
        (r"^go\s+down\s+(?:the\s+)?stairs?$",        r"go down"),
        (r"^ascend(?:\s+(?:the\s+)?stairs?)?$",      r"go up"),
        (r"^descend(?:\s+(?:the\s+)?stairs?)?$",     r"go down"),
